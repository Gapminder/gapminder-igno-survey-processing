...
attributes_to_columns_maps = {
    "gs_combined": {
        ...
        "imported_igno_questions": {
            ...
            "foreign_country_igno_question": "Question ",
            "foreign_country_igno_index_question_correct_answer": "Correct Answer",
            "foreign_country_igno_question_answer_options": "Answer options",
            "foreign_country_igno_index_question_very_wrong_answer": "Very Wrong Answer - filled out only if it can't be derived numerically",
            "step5_question_id": "Step 5 Question ID",
